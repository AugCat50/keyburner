...
function main_ready(){
    ...
    //Первый блок
    let changeMainTextarea = document.querySelector('.js-main-textarea');
    changeMainTextarea.oninput = function(){
    ...
    let changeWorkTextarea     = document.querySelector('.js-work-textarea');
    let start_time, end_time;
    let template_length = 0;
    let wrong_length = 0;
    let errors = 0;
        
    changeWorkTextarea.oninput = function(e){
        let word        = [];
        ...
        //Блокировка текста work_area, если это ещё не сделано
        ...
        if(MAIN_STATUS === false){
            ...
            $(".js-main-textarea").replaceWith("<div class='css-textarea js-div-main-textarea'><pre><div class='main-inner'></div><span class='js-main-span'>"+CLONE_TEXT+"</span></pre></div>");
            MAIN_STATUS = true;
...
//                console.log(penalty_speed.toFixed(3));
    ...
    $(".js-main").on('click', ".js-replaceWith", function(){
        if(MAIN_STATUS === true){
            $(".js-div-main-textarea").replaceWith("<textarea class='css-main-textarea css-textarea js-main-textarea js-textarea' placeholder='Добавьте ваш текст в это окно или выберите текст из списка'>"+CLONE_TEXT+"</textarea>");
